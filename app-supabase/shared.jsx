...
window.BergUI = { Ico, refreshIcons, useDB, ToastHost, useToast, Shell, PageWrap, Empty, StageBadge, SectionTitle, EditRow, MessageThread, NotesPanel, UploadButton, downloadDoc, canDownload, fmtSize, extType, MARK_REV, LOGO_REV };
